...
<template>
  <section class="snap-slide">
    <PageHeader
      ...
      subtitulo="Visibilidad perdida sobre tareas, vencimientos y cambios entre equipos. TaskManager separa presentación, lógica y datos con un contrato API-first."
    />
    ...
    <div class="mt-2">
      ...
      <p data-anim class="mt-2 max-w-3xl text-base text-muted-foreground">
        Dos roles humanos (invitado, autenticado) y un actor «sistema» para broadcasting realtime.
      </p>

...
<template>
  <section class="snap-slide">
    <PageHeader
      ...
      subtitulo="Modelado UML: Invitado y Usuario autenticado frente al sistema, con relaciones «include» y mensajes en tiempo real."
    />
    ...
    <div data-anim class="mb-12">
      ...
      <p class="mt-2 text-base text-muted-foreground">
        Cuatro principales (CRUD y autenticación) y cuatro secundarios (docs, verificación, realtime, logout).
      </p>
